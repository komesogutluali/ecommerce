							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									<c:forEach items="${brandCounts}" var="bc">
										<li><a href="#"> <span class="pull-right">(${bc.brand_count})</span>${bc.brandName}</a></li>
									</c:forEach>
								</ul>
							</div>
						</div><!--/brands_products-->
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										<div class="item active">
										  <a href=""><img src="${pageContext.request.contextPath}/resources/images/product-details/similar1.jpg" alt=""></a>
										  <a href=""><img src="${pageContext.request.contextPath}/resources/images/product-details/similar2.jpg" alt=""></a>
										  <a href=""><img src="${pageContext.request.contextPath}/resources/images/product-details/similar3.jpg" alt=""></a>
										</div>
										<div class="item">
										  <a href=""><img src="${pageContext.request.contextPath}/resources/images/product-details/similar1.jpg" alt=""></a>
										  <a href=""><img src="${pageContext.request.contextPath}/resources/images/product-details/similar2.jpg" alt=""></a>
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<p>${itemDto.comment_description}</p>
									...
									<form action="#">
										...
										<b>Rating: </b> <img src="${pageContext.request.contextPath}/resources/images/product-details/rating.png" alt="" />
